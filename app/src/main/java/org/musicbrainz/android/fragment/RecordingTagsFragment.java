...
public class RecordingTagsFragment extends Fragment {
    ...
    public static RecordingTagsFragment newInstance() {
        ...
        RecordingTagsFragment fragment = new RecordingTagsFragment();
    ...
    private void setTagRecycler() {
        List<Tag> tags = recording.getTags();
        if (tags != null && !tags.isEmpty()) {
            TagAdapter adapter = new TagAdapter(tags, recording.getUserTags());
    ...
    private void postTag(String tag, UserTagXML.VoteType voteType) {
        ...
        api.postRecordingTag(recording.getId(), tag, voteType,
                metadata -> {
